...
Q11 = [132.6*pi/180.0, -62.48*pi/180.0, 103.4*pi/180.0, -134.44*pi/180.0, -90.57*pi/180.0, 0*pi/180.0]
Q12 = [131.81*pi/180.0, -56.82*pi/180.0, 107.21*pi/180.0, -144.02*pi/180.0, -88.39*pi/180.0, 0*pi/180.0]
Q13 = [132.55*pi/180.0, -50.67*pi/180.0, 106.52*pi/180.0, -148.4*pi/180.0, -90.81*pi/180.0, 0*pi/180.0]
Q21 = [146.83*pi/180.0, -45.22*pi/180.0, 71.33*pi/180.0, -118.8*pi/180.0, -90.6*pi/180.0, 0*pi/180.0]
Q22 = [146.11*pi/180.0, -41.75*pi/180.0, 76.32*pi/180.0, -128.51*pi/180.0, -88.64*pi/180.0, 0*pi/180.0]
Q23 = [147.45*pi/180.0, -36.91*pi/180.0, 76.42*pi/180.0, -134.04*pi/180.0, -92.06*pi/180.0, 0*pi/180.0]
Q31 = [143.78*pi/180.0, -68.02*pi/180.0, 114.76*pi/180.0, -141.22*pi/180.0, -88.24*pi/180.0, 0*pi/180.0]
Q32 = [143.89*pi/180.0, -61.61*pi/180.0, 116.4*pi/180.0, -149.8*pi/180.0, -88.92*pi/180.0, 0*pi/180.0]
Q33 = [144.77*pi/180.0, -54.93*pi/180.0, 114.58*pi/180.0, -151.05*pi/180.0, -91.26*pi/180.0, 0*pi/180.0]
...
def main(args=None):
    ...
    try:
        ...
        mid_pos = 3-start_pos-end_pos

        node.move_arm(home)

        moves = [
            (start_pos, 0, end_pos, 2),
            (start_pos, 1, mid_pos, 2),
            (end_pos, 2, mid_pos, 1),
            (start_pos, 2, end_pos, 2),
            (mid_pos, 1, start_pos, 2),
            (mid_pos, 2, end_pos, 1),
            (start_pos, 2, end_pos, 0),
        ]

        for start_tower, start_height, end_tower, end_height in moves:
            if not node.move_block(start_tower, start_height, end_tower, end_height):
                node.get_logger().error("Failed to move block. Stopping.")
                node.move_arm(home)
                return
